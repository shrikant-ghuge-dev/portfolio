...
import Resume from './Shrikant_Ghuge_Resume_5+Exp.pdf';
      ...
      <div className="cards">
        ...
        >
          <Card
            emoji={HeartEmoji}
            heading={"Frontend"}
            detail={"Angular, React, HTML5, CSS, JavaScript, TypeScript, Bootstrap"}
          />
        </motion.div>
        {/* second card */}
        <motion.div
        ...
        >
          <Card
            emoji={Glasses}
            heading={"Backend"}
            detail={"Proficient in backend development using Nextjs, Nodejs, Express, and MongoDB."}
          />
        </motion.div>
        {/* 3rd */}
        <motion.div
        ...
        >
          <Card
            ...
            heading={"SEO"}
            detail={
              "Provide Search Engine Optimization (SEO) solutions for websites."
            }
